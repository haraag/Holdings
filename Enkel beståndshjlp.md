...
De mest vanliga fälten finns färdiga att fylla i. Det motsvarar vad som kunde göras i Libris webbregistrering. Övriga fält läggs till via *+ikonen* för bestånd. För hjälp med detta se Beståndsregistrering.
